...
" Some of them
" change Vim's behaviour in ways which deviate from the true Vi
" way, but
" which are considered to add usability. Which, if any, of these
" options to
...
" is enabled, keep
" the same indent as the line you're currently on. Useful for
" READMEs, etc.
set autoindent
...
" Always display the status line, even if only one window
" is displayed
set laststatus=2
...
" Quickly time out on keycodes, but never time out
" on mappings
...
" Indentation settings for using hard tabs for
" indent. Display tabs as
...
" Map <Space> to single character insert
nmap <Space> i_<Esc>r
